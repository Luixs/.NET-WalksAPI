...
namespace Walks.API.Data
{
    public class WalksDbContext: DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                new Difficulty() {
                  Id= Guid.Parse("738094a6-3e77-4fab-aa88-59c7a03c8d1d"),
                  Name = "Easy"
                },
                new Difficulty() {
                    Id = Guid.Parse("a57a0423-d7b5-4db0-b5e1-9f879450ee49"),
                    Name = "Medium"
                },
                new Difficulty() {
                    Id = Guid.Parse("96a981a5-fa01-4602-975c-c492c1779d74"),
                    Name = "Hard"
                },
            };
