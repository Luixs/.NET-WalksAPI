...
{
    /// <inheritdoc />
    public partial class _002AddingDataForDifficultiesAndRegions : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("738094a6-3e77-4fab-aa88-59c7a03c8d1d"), "Easy" },
                    { new Guid("96a981a5-fa01-4602-975c-c492c1779d74"), "Hard" },
                    { new Guid("a57a0423-d7b5-4db0-b5e1-9f879450ee49"), "Medium" }
                });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("738094a6-3e77-4fab-aa88-59c7a03c8d1d"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("96a981a5-fa01-4602-975c-c492c1779d74"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("a57a0423-d7b5-4db0-b5e1-9f879450ee49"));
